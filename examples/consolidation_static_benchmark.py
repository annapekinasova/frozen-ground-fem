...
def main():
    ...
    (
        ...
        Uz_nod_Gs_278_OC,
        sig_p_int_Gs_278_OC,
        ue_norm_int_Gs_278_OC,
        hyd_cond_int_Gs_278_OC,
        t_50_Gs_278_OC,
        run_time_Gs_278_OC,
    ) = solve_consolidation_benchmark(
        Gs=2.78,
    ...
    plt.subplot(2, 2, 1)
    plt.plot(e_nod_Gs_1[:, 0], z_nod_Gs_1, "--b")
    plt.plot(
        e_FP15_Gs_1[:, 0],
        z_FP15,
        marker="x",
    ...
    plt.plot(e_nod_Gs_278[:, 0], z_nod_Gs_278, "-r")
    plt.plot(
        e_FP15_Gs_278[:, 0],
        z_FP15,
        marker="x",
    ...
    for kk, kk_plot in enumerate(k_plot[:-1]):
        ...
        plt.plot(
            ue_norm_int_Gs_278_OC[::6, kk_plot],
            z_int_Gs_278_OC[::6],
            marker=k_plot_lts[kk],
            linestyle="none",
            markeredgecolor="red",

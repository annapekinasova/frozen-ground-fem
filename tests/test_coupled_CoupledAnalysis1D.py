...
class TestGlobalCorrectionCubicIterative(unittest.TestCase):
    ...
    def test_vol_heat_cap_distribution(self):
        expected_vol_heat_cap_int_pts = np.array([
            3.41832179571698E+06,
            2.07171410689456E+06,
            2.04066558690832E+06,
            2.04972079863794E+06,
            2.05017997236275E+06,
            2.04671323512722E+06,
            2.04589612467034E+06,
            2.04575786717713E+06,
            2.04599451740763E+06,
            2.04587893404750E+06,
            2.04580074770793E+06,
            2.04587450210258E+06,
            2.04588722945674E+06,
            2.04586546693455E+06,
            2.04587615162508E+06,
            2.04588329639208E+06,
            2.04587639019939E+06,
            2.04587540796020E+06,
            2.04587731189395E+06,
            2.04587569440347E+06,
        ])
        actual_vol_heat_cap_int_pts = np.array([
            ip.vol_heat_cap
            for e in self.msh.elements for ip in e.int_pts
    ...
    def test_tot_stress_distribution_int_pts(self):
        expected_sig_int_pts = np.array([
            1.50270219219508E+04,
            1.50808831554909E+04,
            1.51688956082446E+04,
            1.52602387313300E+04,
            1.53202020491082E+04,
            1.53503699846414E+04,
            1.54114031211700E+04,
            1.55007870244878E+04,
            1.55901727836115E+04,
            1.56512093201415E+04,
            1.56823557632528E+04,
            1.57433945806791E+04,
            1.58327778470867E+04,
            1.59221608852068E+04,
            1.59831992843901E+04,
            1.60143467999937E+04,
            1.60753849209441E+04,
            1.61647682623758E+04,
            1.62541516355449E+04,
            1.63151898146409E+04,
        ])
        actual_sig_int_pts = np.array([
            ip.tot_stress
            for e in self.msh.elements for ip in e.int_pts
    ...
    def test_tot_stress_grad_distribution(self):
        expected_dsigde_int_pts = np.array([
            0.00000000000000E+00,
            -1.88258172696558E+41,
            -7.02017314734135E-12,
            -1.01103461885862E+19,
            -5.70256791894480E+16,
            -8.46201300381934E+06,
            -5.38058285047512E+06,
            -5.10133829393024E+06,
            -5.94737415898987E+06,
            -5.49206543188994E+06,
            -5.24306334510869E+06,
            -5.56728817866143E+06,
            -5.63808524023088E+06,
            -5.56895321899750E+06,
            -5.64851895464935E+06,
            -5.69239285034752E+06,
            -5.67403899313400E+06,
            -5.70232071329682E+06,
            -5.74596378579855E+06,
            -5.75533308714600E+06,
        ])
        actual_dsigde_int_pts = np.array([
            ip.tot_stress_gradient
            for e in self.msh.elements for ip in e.int_pts
    ...
    def test_global_heat_flow_matrix(self):
        expected_H = np.zeros((self.msh.num_nodes, self.msh.num_nodes))
        expected_H[0:4, 0:4] = np.array([
            [3.48781836546058E+02, -4.38905172104480E+02,
                1.18638999958430E+02, -2.85156644000068E+01,],
            [-4.38905172104480E+02, 9.55262794271496E+02, -
                6.35105767134820E+02, 1.18748144967805E+02,],
            [1.18638999958430E+02, -6.35105767134820E+02,
                9.30881330356296E+02, -4.14414563179905E+02,],
            [-2.85156644000068E+01, 1.18748144967805E+02, -
                4.14414563179905E+02, 6.36282977995296E+02,],
        ])
        expected_H[3:7, 3:7] = np.array([
            [6.36282977995296E+02, -3.98572992385527E+02,
                1.13887815917911E+02, -2.74157189155734E+01,],
            [-3.98572992385527E+02, 9.10963299218432E+02, -
                6.26252906720161E+02, 1.13862599887255E+02,],
            [1.13887815917911E+02, -6.26252906720161E+02,
                9.10872612417769E+02, -3.98507521615519E+02,],
            [-2.74157189155734E+01, 1.13862599887255E+02, -
                3.98507521615519E+02, 6.24110303354203E+02,],
        ])
        expected_H[6:10, 6:10] = np.array([
            [6.24110303354203E+02, -3.98493767037540E+02,
                1.13853600875775E+02, -2.74094965486020E+01,],
            [-3.98493767037540E+02, 9.10854463756617E+02, -
                6.26218847004048E+02, 1.13858150284970E+02,],
            [1.13853600875775E+02, -6.26218847004048E+02,
                9.10871430221844E+02, -3.98506184093572E+02,],
            [-2.74094965486020E+01, 1.13858150284970E+02, -
                3.98506184093572E+02, 6.24116875065304E+02,],
        ])
        expected_H[9:13, 9:13] = np.array([
            [6.24116875065304E+02, -3.98508535924215E+02,
                1.13859829844230E+02, -2.74106386281150E+01,],
            [-3.98508535924215E+02, 9.10874859330671E+02, -
                6.26225367323129E+02, 1.13859043916674E+02,],
            [1.13859829844230E+02, -6.26225367323129E+02,
                9.10871885528700E+02, -3.98506348049800E+02,],
            [-2.74106386281150E+01, 1.13859043916674E+02, -
                3.98506348049800E+02, 3.12057942761241E+02,],
        ])
        self.assertTrue(np.allclose(
            expected_H, self.msh._heat_flow_matrix,
        ))
    ...
    def test_global_heat_storage_matrix(self):
        expected_C = np.zeros((self.msh.num_nodes, self.msh.num_nodes))
        expected_C[0:4, 0:4] = np.array([
            [4.43409364026058E+04, 2.37026354282405E+04, -
                1.04272010276310E+04, 2.72763642069820E+03,],
            [2.37026354282405E+04, 3.89701284179230E+04, -
                8.54470011893541E+03, -4.23046179021659E+02,],
            [-1.04272010276310E+04, -8.54470011893541E+03,
                2.86933950175783E+04, 3.69432573102179E+03,],
            [2.72763642069820E+03, -4.23046179021659E+02,
                3.69432573102179E+03, 1.11346810388318E+04,],
        ])
        expected_C[3:7, 3:7] = np.array([
            [1.11346810388318E+04, 4.34340381499804E+03, -
                1.57619756900004E+03, 8.33097629193998E+02,],
            [4.34340381499804E+03, 2.83430733122225E+04, -
                3.57302603099385E+03, -1.57723742387397E+03,],
            [-1.57619756900004E+03, -3.57302603099385E+03,
                2.82510622342046E+04, 4.34548352474590E+03,],
            [8.33097629193998E+02, -1.57723742387397E+03,
                4.34548352474590E+03, 1.12150223592120E+04,],
        ])
        expected_C[6:10, 6:10] = np.array([
            [1.12150223592120E+04, 4.32859868586274E+03, -
                1.56913477807286E+03, 8.33573084771995E+02,],
            [4.32859868586274E+03, 2.83547525101554E+04, -
                3.57098738915109E+03, -1.58677953854261E+03,],
            [-1.56913477807286E+03, -3.57098738915109E+03,
                2.82219785114869E+04, 4.36388820680224E+03,],
            [8.33573084771995E+02, -1.58677953854261E+03,
                4.36388820680224E+03, 1.12649200195124E+04,],
        ])
        expected_C[9:13, 9:13] = np.array([
            [1.12649200195124E+04, 4.37301532545413E+03, -
                1.58246109433924E+03, 8.28013034459200E+02,],
            [4.37301532545413E+03, 2.86286859810312E+04, -
                3.62427941032693E+03, -1.53955099233934E+03,],
            [-1.58246109433924E+03, -3.62427941032693E+03,
                2.81606889518058E+04, 4.28719512145432E+03,],
            [8.28013034459200E+02, -1.53955099233934E+03,
                4.28719512145432E+03, 5.54895519466056E+03,],
        ])
        self.assertTrue(np.allclose(
            expected_C, self.msh._heat_storage_matrix,
        ))
    ...
    def test_global_stiffness_matrix(self):
        expected_K = np.zeros((self.msh.num_nodes, self.msh.num_nodes))
        expected_K[0:4, 0:4] = np.array([
            [5.94203088797570E-09, -8.84986336224903E-09,
                3.67829829183976E-09, -7.70465817566433E-10,],
            [-3.14908350609378E-09, 4.69014033596454E-09, -
                1.94937870564851E-09, 4.08321875777741E-10,],
            [1.24307653330092E-09, -1.85139688364682E-09,
                7.69502275445856E-10, -1.61181925099959E-10,],
            [-2.55613027492832E-10, 3.80701549616653E-10, -
                1.58232257644690E-10, 3.31437355208682E-11,],
        ])
        self.assertTrue(np.allclose(
            expected_K, self.msh._stiffness_matrix,
            atol=1e-18, rtol=1e-8,
    ...
    def test_global_mass_matrix(self):
        expected_M = np.zeros((self.msh.num_nodes, self.msh.num_nodes))
        expected_M[0:4, 0:4] = np.array([
            [4.93106149490779E-04, 3.70665591426933E-04, -
                1.36612124184337E-04, 6.93487670448556E-05,],
            [3.70665591426933E-04, 2.31049595218586E-03, -
                2.92324029174779E-04, -1.26736655988384E-04,],
            [-1.36612124184337E-04, -2.92324029174779E-04,
                2.30161464448372E-03, 3.50914655035027E-04,],
            [6.93487670448556E-05, -1.26736655988384E-04,
                3.50914655035027E-04, 9.08591206911955E-04,],
        ])
        expected_M[3:7, 3:7] = np.array([
            [9.08591206911955E-04, 3.51306762121986E-04, -
                1.27747853029511E-04, 6.74215846202641E-05,],
            [3.51306762121986E-04, 2.29940109143339E-03, -
                2.87433168188893E-04, -1.27743749730195E-04,],
            [-1.27747853029511E-04, -2.87433168188893E-04,
                2.29940534935140E-03, 3.51298555523355E-04,],
            [6.74215846202641E-05, -1.27743749730195E-04,
                3.51298555523355E-04, 9.08402597666534E-04,],
        ])
        expected_M[6:10, 6:10] = np.array([
            [9.08402597666534E-04, 3.51295973206610E-04, -
                1.27743997257332E-04, 6.74205222159855E-05,],
            [3.51295973206610E-04, 2.29939731098759E-03, -
                2.87423936075839E-04, -1.27744363368629E-04,],
            [-1.27743997257332E-04, -2.87423936075839E-04,
                2.29939692522698E-03, 3.51296705429205E-04,],
            [6.74205222159855E-05, -1.27744363368629E-04,
                3.51296705429205E-04, 9.08404127592076E-04,],
        ])
        expected_M[9:13, 9:13] = np.array([
            [9.08404127592076E-04, 3.51296938316570E-04, -
                1.27744341457428E-04, 6.74206165137023E-05,],
            [3.51296938316570E-04, 2.29939764527292E-03, -
                2.87424766205142E-04, -1.27744305153375E-04,],
            [-1.27744341457428E-04, -2.87424766205142E-04,
                2.29939768347813E-03, 3.51296865708465E-04,],
            [6.74206165137023E-05, -1.27744305153375E-04,
                3.51296865708465E-04, 4.54201987961274E-04,],
        ])
        self.assertTrue(np.allclose(
            expected_M, self.msh._mass_matrix,
            atol=1e-18, rtol=1e-8,

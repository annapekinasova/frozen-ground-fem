...
class TestUpdateWeightedMatricesCubic(unittest.TestCase):
    ...
    def test_global_heat_flow_matrix_weighted(self):
        expected_H = np.zeros((self.msh.num_nodes, self.msh.num_nodes))
        expected_H[0:4, 0:4] = np.array([
[0.3754127757099620, -0.4791349563299290, 0.1366244808437270, -0.0329023002237587],
[-0.4791349623925930, 1.0974938702568300, -0.7555601482973810, 0.1372012404331490],
[0.1366244834335360, -0.7555601484015830, 1.1003657741573600, -0.4814301091893070],
[-0.0329023007712942, 0.1372012404625230, -0.4814301091924440, 0.7513590624829260],
        ])
        expected_H[3:7, 3:7] = np.array([
[0.7513590624829260, -0.4704047663661540, 0.1245490529816890, -0.0283721795972456],
[-0.4704044695643160, 1.0458062449151100, -0.6891123373729850, 0.1137105620221960],
[0.1245484594009230, -0.6891043240405850, 0.9190421952958320, -0.3544863306561690],
[-0.0283721466203953, 0.1137099684405900, -0.3544860338663970, 0.5359698377434610],
        ])
        expected_H[6:10, 6:10] = np.array([
[0.5359698377434610, -0.3407384274106900, 0.0973538364030547, -0.0234370346896243],
...
[-0.0234370346896243, 0.0973538364030541, -0.3407384274106900, 0.5958500379379190],
        ])
        expected_H[9:13, 9:13] = np.array([
[0.5958500379379190, -0.4131199413318780, 0.1111410332402880, -0.0270495041490680],
[-0.4135246144137550, 0.9869955536278930, -0.6972079946668100, 0.1237370554526720],
[0.1113006435889920, -0.6972323578968160, 1.0422001879261100, -0.4562684736182830],
[-0.0270753013289352, 0.1237052894950540, -0.4561656685786790, 0.3595356804125600],
        ])
        self.assertTrue(np.allclose(
            expected_H, self.msh._weighted_heat_flow_matrix,
        ))
